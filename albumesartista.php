...
<html lang="en">
  ...
  <form class="form-inline" action='busqueda.php' method='post'>
    ...
    <?php
        ...
        echo "<form action='crearalbum.php'>";
        echo "<button type='submit' class='btn btn-link' name='crearalbum'>Crear Album</button>";
        echo "<br>";
        echo "</form>";

        echo "<form action='albumsongs.php' method='post'>";
        foreach($albumes as $album){
            $albumname = $album->getNombre();
            $albumid = $album->getId();
            echo "<button type='submit' class='btn btn-link' name='album' value='" . $albumid . "'>" . $albumname . "</button>";
            echo "<br>";
        }
        echo "</form>";
    ?>
